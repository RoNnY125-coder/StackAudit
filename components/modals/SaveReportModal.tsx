    ...
    <div className="fixed inset-0 bg-background/90 flex items-center justify-center z-50 p-4">
      ...
      >
        ...
        {!isSuccess ? (
          <>
            <div className="mb-6">
              <h2 id="modal-title" className="text-xl font-bold text-on-surface mb-1">Save your audit</h2>
              <p className="text-on-surface-variant text-sm">We'll send the full report to your inbox.</p>
            </div>

            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="space-y-1">
                <Label htmlFor="email" className="text-xs font-mono text-on-surface-variant uppercase">Email</Label>
                <Input 
                  id="email"
                  ref={inputRef}
                  type="email" 
              ...
              <div className="space-y-1">
                <Label htmlFor="company" className="text-xs font-mono text-on-surface-variant uppercase">Company</Label>
                <Input 
                  id="company"
                  type="text" 
                  required 
              ...
              <div className="space-y-1">
                <Label htmlFor="role" className="text-xs font-mono text-on-surface-variant uppercase">Role</Label>
                <Input 
                  id="role"
                  type="text" 
                  required 
